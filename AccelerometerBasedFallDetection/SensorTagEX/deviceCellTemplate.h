...
@interface accelerometerCellTemplate : UITableViewCell {
    ...
    UILabel *accValueY;
    UILabel *accValueZ;
    UILabel *xTiltAngle;  // added code
    UILabel *yTiltAngle;  // added code
...
@property (nonatomic,retain) UILabel *xTiltAngle;  // adde code for tilt angle display
@property (nonatomic,retain) UILabel *yTiltAngle; // added code for tilt angle display
