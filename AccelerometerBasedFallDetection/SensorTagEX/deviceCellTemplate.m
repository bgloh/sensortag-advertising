...
@synthesize accLabel,accIcon,accValueX,accValueY,accValueZ,accGraphX,accGraphY,accGraphZ,accGraphHolder,accCalibrateButton,height, xTiltAngle, yTiltAngle;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.accLabel.font = [UIFont italicSystemFontOfSize:17]; //17
       ...
       // self.accIcon.image = [UIImage imageNamed:@"accelerometer.png"];
        ...
        self.accValueX.font = [UIFont italicSystemFontOfSize:17];
        ...
        self.accValueY.font = [UIFont italicSystemFontOfSize:17];
        ...
        self.accValueZ.font = [UIFont italicSystemFontOfSize:17];
        self.accValueZ.backgroundColor = [UIColor clearColor];
        
        // added code for tilt angles
        self.xTiltAngle = [[UILabel alloc] init];
        self.xTiltAngle.textAlignment = NSTextAlignmentRight;
        self.xTiltAngle.font = [UIFont italicSystemFontOfSize:17];
        self.xTiltAngle.backgroundColor = [UIColor clearColor];
        self.yTiltAngle = [[UILabel alloc] init];
        self.yTiltAngle.textAlignment = NSTextAlignmentRight;
        self.yTiltAngle.font = [UIFont italicSystemFontOfSize:17];
        self.yTiltAngle.backgroundColor = [UIColor clearColor];
       ...
       /* [self.accGraphHolder addSubview:self.accGraphX];
        ...
        [self.contentView addSubview:self.xTiltAngle]; // added for for tilt display
        [self.contentView addSubview:self.yTiltAngle]; // added for for tilt display
...
-(void)layoutSubviews {
    ...
    if (self.contentView.bounds.size.width < WIDTH_CHECKER) self.height = 150;
    ...
    if (contentRect.size.width < WIDTH_CHECKER) {
        ...
        fr = CGRectMake(contentRect.origin.x + self.contentView.bounds.size.width - 5, 10, -100, 25);
        ...
        fr = CGRectMake(contentRect.origin.x + self.contentView.bounds.size.width - 5, 10, -140, 25);
        fr.origin.x = 200;
        fr.origin.y = 50;
        self.xTiltAngle.frame = fr; // added for ROTz display
        fr.origin.y += 25;
        self.yTiltAngle.frame = fr; // added for ROTx display
